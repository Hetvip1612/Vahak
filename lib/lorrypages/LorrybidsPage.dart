...
class LorrybidsPage extends StatefulWidget {
  const LorrybidsPage({super.key});

  @override
  State<LorrybidsPage> createState() => _LorrybidsPageState();
}

class _LorrybidsPageState extends State<LorrybidsPage> {
